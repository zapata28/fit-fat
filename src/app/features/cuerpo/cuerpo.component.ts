...
const FRONT_OVERLAYS: Overlay[] = [
  { group: "Hombro", shape: "oval", top: 19.7, left: 28, width: 15, height: 2 },
  { group: "Hombro", shape: "oval", top: 19.7, left: 57, width: 15, height: 2 },
  { group: "Pecho", shape: "oval", top: 21.5, left: 28.1, width: 43.9, height: 8.2 },
  { group: "Abdomen", shape: "oval", top: 32, left: 36.4, width: 27.2, height: 13.7 },
  { group: "Bíceps", shape: "oval", top: 25.9, left: 21, width: 7, height: 8.2 },
  { group: "Bíceps", shape: "oval", top: 25.9, left: 72, width: 7, height: 8.2 },
  { group: "Antebrazo", shape: "oval", top: 37.7, left: 17, width: 7.5, height: 5.8 },
  { group: "Antebrazo", shape: "oval", top: 37.7, left: 75.5, width: 7.5, height: 5.8 },
  { group: "Pierna", shape: "oval", top: 52.3, left: 32.1, width: 16.55, height: 15.75 },
  { group: "Pierna", shape: "oval", top: 52.3, left: 51.35, width: 16.55, height: 15.75 },
  { group: "Pierna", shape: "oval", top: 73.25, left: 33.5, width: 10.6, height: 10.2 },
  { group: "Pierna", shape: "oval", top: 73.25, left: 55.9, width: 10.6, height: 10.2 },
];

const BACK_OVERLAYS: Overlay[] = [
  { group: "Hombro", shape: "oval", top: 20.5, left: 26, width: 12, height: 2 },
  { group: "Hombro", shape: "oval", top: 20.5, left: 62, width: 12, height: 2 },
  { group: "Espalda", shape: "oval", top: 20.7, left: 31.5, width: 37.1, height: 19.2 },
  { group: "Glúteo", shape: "oval", top: 45.1, left: 29.5, width: 41, height: 8.5 },
  { group: "Tríceps", shape: "oval", top: 27.6, left: 16.7, width: 8.05, height: 8.45 },
  { group: "Tríceps", shape: "oval", top: 27.6, left: 75.25, width: 8.05, height: 8.45 },
  { group: "Antebrazo", shape: "oval", top: 37.9, left: 12, width: 6.35, height: 6.7 },
  { group: "Antebrazo", shape: "oval", top: 37.9, left: 81.65, width: 6.35, height: 6.7 },
  { group: "Pierna", shape: "oval", top: 55.15, left: 27.9, width: 17.6, height: 12.1 },
  { group: "Pierna", shape: "oval", top: 55.15, left: 54.5, width: 17.6, height: 12.1 },
  { group: "Pierna", shape: "oval", top: 74.75, left: 28.5, width: 13.1, height: 8.95 },
  { group: "Pierna", shape: "oval", top: 74.75, left: 58.4, width: 13.1, height: 8.95 },
];
